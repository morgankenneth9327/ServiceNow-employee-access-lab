...
|---|---|
| Hiring Manager | Initiates onboarding/access requests |
...
- A hiring manager can submit a complete onboarding request.
...
- Rejected privileged-access requests do not proceed through privileged fulfillment.
...
- The project does not have access to production enterprise systems.
- Test data will be fictional.
